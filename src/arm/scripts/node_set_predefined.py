...
class MyRobot:
    ...
    def __init__(self, Group_Name):
        ...
        rospy.init_node('node_set_redefined', anonymous=True)
...
the_msg = Int32()
def callback(center_segment_number):
    global the_msg
    the_msg = center_segment_number.data

def main():
    rospy.Subscriber("/center_segment", Int32 ,callback)
    #Create a new arm object from the MyRobot class
    arm = MyRobot("arm_group1")
    hand =  MyRobot("hand1")
